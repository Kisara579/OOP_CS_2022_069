...
//        if (selection == 0) System.out.println("You selected Magenta");
//        else if (selection == 1) System.out.println("You selected Cyan");
//        else if (selection == 2) System.out.println("You selected Red");
//        else if (selection == 3) System.out.println("You selected Blue");
//        else if (selection == 4) System.out.println("You selected Green");
//
